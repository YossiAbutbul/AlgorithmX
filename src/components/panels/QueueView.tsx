  ...
  return (
    <div>
      <div className="flex min-h-[42px] items-center gap-1.5" dir="rtl">
        <span className="text-(length:--step-1) font-semibold text-ink-soft">ראש</span>
        <div className="flex flex-1 flex-wrap gap-1.5">
          ...
          {view.items.map((it, i) => (
            <span
              ...
              className="item-in num rounded-lg border px-2.5 py-1 text-(length:--step-2) font-semibold"
              style={{
        ...
        <span className="text-(length:--step-1) font-semibold text-ink-soft">זנב</span>
      </div>
